...
import { prepareAnalytics } from "@/lib/analytics-prep";
...
export default async function ProgressPage() {
  ...
  const analytics = prepareAnalytics(sessions);
...
return (
    <main className="min-h-screen bg-cream text-ink px-4 py-8">
      <div className="mx-auto max-w-2xl">
        ...
        <ProgressTabs analytics={analytics}>
          {/* Log tab content: the log form + history */}
          <LogWorkout />
